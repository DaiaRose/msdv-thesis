<template>
  <div class="depression-viz">
    <h2>Depressive Symptoms by Identity Group</h2>
    <p>
      Adjust the % of schools teaching LGBTQ-inclusive sex ed. Each grid shows the estimated number of youth experiencing depressive symptoms (out of 24).
    </p>
    ...
    return {
      ...
      groups: [
        ...
        },
        {
          ...
          baselineRate: 0.628,
          oddsRatioPer10: 0.86 * 0.92, // includes interaction effect
          headManifestKey: "gayPeeps",
          faceManifestKey: "facePeeps"
        }
      ]
