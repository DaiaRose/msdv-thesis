<template>
  <div class="suicide-viz">
    <h2>Suicide Plan Rates by Identity Group</h2>
    <p>
      Adjust the % of schools teaching LGBTQ-inclusive sex ed. Each grid shows the estimated number of youth who made a suicide plan (out of 24).
    </p>
